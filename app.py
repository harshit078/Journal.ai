    ...
    if "page" not in st.session_state:
        st.session_state.update({
            ...
            "notes": [
                ("Today I woke up, and didnt want to get out of bed. I just sort of laid there. This made me feel bad.",
                 "sadness", datetime(2024, 1, 4)),
                ("This afternoon, I ate a big meal. This made me feel good, I would like to eat more.", "joy",
                 datetime(2024, 1, 7)),
                ("It was hard for me to sleep yesterday, I had a girl on my mind.", "love", datetime(2024, 1, 7)),
                ("This morning, I got up before my alarm. I was excited to get out of bed!", "joy",
                 datetime(2024, 1, 7)),
                ("Uber gave me a free meal today. I wonder why.", "surprise", datetime(2024, 1, 7)),
                ("I couldnt fall asleap yesterday. I just stared at the cealing.", "anger", datetime(2024, 1, 7)),
                (
                "This morning I woke up with a horrible hedache. Motrin didn't help.", "anger", datetime(2024, 1, 7)),
                ("I havent written a post recently. Its a good habit I should get back into.", "anger",
                 datetime(2024, 1, 7)),
                ("WHY AM I SO STUPID. I failed a quiz today.", "anger", datetime(2024, 1, 7)),
                ("I cant stop thinking about that quiz. I studied so hard.", "sadness", datetime(2024, 1, 7)),
                ("Quiz still on my mind...", "sadness", datetime(2024, 1, 7)),
                ("I finally understand the material for my class!", "joy", datetime(2024, 1, 12)),
                ("Today was a beautiful day", "joy", datetime(2024, 1, 16)),
                ("I look forward to tomorrow", "joy", datetime(2024, 2, 2)),
                ("I spoke to a girl today", "love", datetime(2024, 2, 4)),
                ("I cant decide weather or not to message her...", "love", datetime(2024, 3, 24)),
                ("What a day", "surprise", datetime(2024, 3, 31)),
            ],
            "placeholder_text": "..."
        ...
        for i in range(100):
            st.session_state.notes.append(("Test Note: " + str(i), mood_list[weights[randint(0, 19)]],
                                           datetime(2024, 1 + ((i // 30) % 12), 1 + (i % 27), 0, 0, 0)))
...
def page_home():
    with st.container():
        st.title("🔮 Welcome to Journaling.ai")
        '''
        ##### Please login below to access your AI powered diary.
        '''
...
def page_journal():
    ...
    st.write("How is your day going?")
